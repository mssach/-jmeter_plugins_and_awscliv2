...
RUN wget https://repo1.maven.org/maven2/kg/apc/jmeter-plugins-manager/${JMETER_PMANAGER_VERSION}/jmeter-plugins-manager-${JMETER_PMANAGER_VERSION}.jar \
  ...
  && ${JMETER_HOME}/bin/PluginsManagerCMD.sh install-all-except ulp-jmeter-videostreaming-plugin,ulp-jmeter-autocorrelator-plugin,ulp-jmeter-gwt-plugin,mqtt-xmeter
